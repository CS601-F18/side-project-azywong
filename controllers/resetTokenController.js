...
/**
* controller that handlers the routes for reset password
**/

var controller = {};

/**
* renders forgot password page if the token is valid
* otherwise renders rest password page
**/
...
/**
* attempts to update user's password then send an email confirmation
**/
