...
/**
* controller that handlers the routes for forgot password
**/

var controller = {};

/**
* method that renders the forgot password page
**/
...
/**
* method that generates a token for the user, then sends a reset email
**/
